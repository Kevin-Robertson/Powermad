function Invoke-DNSUpdate
{
    ...
    function New-PacketDNSQuery
    {
        ...
        $DNSQuery.Add("Flags",[Byte[]](0x00,0x00))
        ...
        if($apreq)
        {
            $DNSQuery.Add("AdditionalRRs",[Byte[]](0x00,0x01))
        }
        else
        {
        ...
        $DNSQuery.Add("Queries_Class",[Byte[]](0x00,0xff))

        if($apreq)
        {
            $DNSQuery.Add("Queries_AdditionalRecords_Name",[Byte[]](0xc0,0x0c))
            $DNSQuery.Add("Queries_AdditionalRecords_Type",[Byte[]](0x00,0xf9))
            $DNSQuery.Add("Queries_AdditionalRecords_Class",[Byte[]](0x00,0xff))
            $DNSQuery.Add("Queries_AdditionalRecords_TTL",[Byte[]](0x00,0x00,0x00,0x00))
            $DNSQuery.Add("Queries_AdditionalRecords_RDLength",$RD_length)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_Algorithm",[Byte[]](0x08,0x67,0x73,0x73,0x2d,0x74,0x73,0x69,0x67,0x00))
            $DNSQuery.Add("Queries_AdditionalRecords_RData_Inception",$inception)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_Expiration",$inception)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_Mode",[Byte[]](0x00,0x03))
            $DNSQuery.Add("Queries_AdditionalRecords_RData_Error",[Byte[]](0x00,0x00))
            $DNSQuery.Add("Queries_AdditionalRecords_RData_KeySize",$key_size)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_Encoding",[Byte[]](0x60) + $spnego_length)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_ThisMech",[Byte[]](0x06,0x06,0x2b,0x06,0x01,0x05,0x05,0x02))
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_InnerContextToken_Encoding",[Byte[]](0xa0) + $innercontexttoken_length2 + [Byte[]](0x30) +
                $innercontexttoken_length)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_InnerContextToken_MechTypes_Encoding",[Byte[]](0xa0,0x0d,0x30,0x0b))
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_InnerContextToken_MechType0",[Byte[]](0x06,0x09,0x2a,0x86,0x48,0x86,0xf7,0x12,0x01,0x02,0x02))
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_InnerContextToken_MechToken_Encoding",[Byte[]](0xa2) + $mechtoken_length2 + [Byte[]](0x04) +
                $mechtoken_length)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_SPNego_InnerContextToken_MechToken_Token",$APReq)
            $DNSQuery.Add("Queries_AdditionalRecords_RData_OtherSize",[Byte[]](0x00,0x00))
        }
